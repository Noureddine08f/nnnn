...
const TimeSlots = () => {
  ...
  const handleDelete = async (id) => {
    if (window.confirm(t("Are you sure you want to delete this time slot?"))) {
      try {
  ...
  return (
    <div className="p-4">
      ...
      <form
        ...
        className="mb-8 bg-white p-4 rounded shadow flex flex-wrap gap-4 items-end"
      >
        <div>
        ...
        <button
          type="submit"
          className="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 flex items-center h-[42px]"
        >
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {timeSlots.length === 0 ? (
              <tr>
                ...
                >
                  {t(
                    "No time slots found. Create some above to help build your schedule.",
                  )}
                </td>
              </tr>
            ) : (
