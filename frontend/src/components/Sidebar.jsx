    ...
    <>
      ...
      >
        <div className="flex flex-col h-full">
          {/* Logo Section */}
          <div className="h-16 flex items-center pt-1 px-6 border-b border-gray-50 bg-linear-to-r from-indigo-50 to-white">
            <span className="text-md font-bold bg-clip-text text-transparent bg-linear-to-r from-blue-400 to-blue-600 cursor-none">
              INSFP Web Scheduler
            </span>
          </div>
